            ...
            <div class="row w-100">
                <div class="col-lg-6 col-12 mx-auto ">
                    <div class="d-flex flex-column align-items-center justify-content-center h-100">
                        <h1 class="text-capitalize fw-bold ff-ubunto fs-my-1 text-center balence "></h1>
                        <img src="../assets/uploads/view/500.svg" class="img-fluid  w-100 px-5" width="500" height="500"
                            srcset=""
                            loading="lazy"
                            decoding="async"
